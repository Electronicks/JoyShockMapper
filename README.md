...
* Gentoo: ```media-libs/libsdl2 dev-libs/libayatana-appindicator dev-libs/libevdev x11-libs/gtk+ dev-libs/libusb dev-libs/hidapi``` The clang installed by default is sufficent to build the program
